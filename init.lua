...
vim.opt.tabstop = 4 -- A tab character represents 2 spaces

--  How many spaces for <Tab> in insert mode
...
require('lazy').setup({
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        lua = { 'stylua', 'prettier', 'prettierd', 'ast-grep' },
  ...
  },
  {
    'mattn/emmet-vim',
    config = function()
      -- Set your leader key for Emmet (here Ctrl-Z)
